...
[![OG image for the OpenSauced workspace for jsr](https://www.nickyt.co/images/posts/_uploads_articles_n9v3aq0eu0lsoxni8b3z.png)](https://app.opensauced.pizza/workspaces/760ea8ea-ebd3-4f9a-91ab-780384e3c102)
...
[![OG image for the huggingface/transformers repository](https://www.nickyt.co/images/posts/_uploads_articles_7wrvyq2qqjwefpeklraf.png)](https://app.opensauced.pizza/s/huggingface/transformers)
...
![OG image for the OpenSauced workspace for jsr with sections outline in green squares denoting dynamic portions of the image](https://www.nickyt.co/images/posts/_uploads_articles_32npdvf35s50hjl9r9iv.png)
...
{% embed "https://github.com/ascorbic/og-edge" %}

Under the hood, og_edge and @vercel/og use the Satori library.

> Satori: Enlightened library to convert HTML and CSS to SVG.

{% embed "https://github.com/vercel/satori" %}
...
{% embed "https://github.com/open-sauced/app/pull/2939" %}

{% embed "https://github.com/open-sauced/app/pull/3117" %}
